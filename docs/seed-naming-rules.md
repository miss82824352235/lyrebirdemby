...
分辨率是决定视频画面清晰度的核心指标，它表示画面由多少个像素点组成。文件名中的分辨率标签能让你一眼就判断出视频的清晰度等级。


核心概念： "p" 与 "i" 的区别
在了解具体分辨率之前，必须先明白数字后面的字母含义：
...
级别              常见标识             俗称/别名   描述与应用场景                                            像素尺寸 (宽x高）                                                                          

超高清          Ultra HD        8K / 4320p / UHD                                      7680x4320                                                                 目前的画质巅峰。像素数量是4K的4倍。目前资源极其稀少，主要用于顶级演示片、IMAX片源或少数高端流媒体内容。文件体积极为庞大。

超高清          Ultra HD        4k / 2160p / UHD / Ultra HD                      通常4096x2160 或 3840x2160                                        当前高质量视频的主流标准。UHD蓝光、高端流媒体平台（Netflix、Disney+）的顶级画质。需要强大的硬件解码能力和支持4K的显示设备才能完美体验。

全高清          Quad HD       2K (非严格) / 1440p / QHD / Quad HD        通常是 2560x1440，但底线要求是 2048x1080                 4倍HD，应用最广泛、最常见的高清标准。几乎所有蓝光碟、WEB-DL、HDTV资源都有这个分辨率。在清晰度和文件大小之间取得了最佳平衡，是绝大多数用户的收藏首选。

全高清          Full HD          1080p /1080i / FHD / Full HD                     1920x1080                                                                   主要来自高清电视广播录制 (HDTV)，如体育赛事、演唱会、电视节目等。由于是隔行扫描，静态画质与1080p相近，但动态画质稍逊。

高清               HD               720p / HD / 高清                                       1280x720                                                                     高清的入门标准。常见于早期的蓝光碟、HDTV录制、流媒体平台的“高清”选项以及很多动漫番剧的BDRip。在移动设备或小屏幕上观看效果依然出色。                                                               

标准清晰度      SD               PAL制式 / 576p / 576i / SDTV / 标清          1024x576 或 720x576                                                   主要来源于欧洲、澳大利亚和中国等地区的DVD或标清电视信号。

标准清晰度      SD               NTSC制式 / 480p / 480i / SDTV / 标清        720x480 或 640x480                                                     主要来源于美国、日本等地区的DVD或标清电视信号。是DVDRip资源最常见的分辨率。在今天看来清晰度已经较低。    

更低分辨率                         360p / 240p /144p                                     640x360 或 480x360 / 320x240 或 426x240 / 192x144    这些分辨率极少出现在正式的电影剧集发布中，通常只用于早期的网络视频、视频预览或在极差网络环境下的流媒体播放。  
...
TC: 胶片版。TC使用电视电影机从胶片直接数字拷贝。画面质量还不错,但亮度不足，有些昏暗。很多时候制作TC使用的音源来自TS，因此音质很差，但画面质量远好过


TS。TC也可以与一些分辨率组合例如HDTC。
...
HDR10+ / HDR10PLUS: 由三星、亚马逊、松下和20世纪福斯等公司联合推出的，可兼容 HDR10，具有与杜比视界相似的优势，但不收取版权费用。HDR10+ 可以看做 
HDR10 的升级，添加了“动态元数据”技术，即为每一帧或每一段视频的内容指定亮度和对比度的信息。
...
DDP5.1是声音格式，它一般有两部分，前者DDP为音频编码（DDP见下文阐述），后者5.1代表声道形式：5方向声道加1个重低音声道，适配5.1功放音响系统，5.1系统也可写作6CH；同理7.1系统也可写作8CH；2.0系统（只有左右声道）也可写作2CH；CH是英文单词channel的缩写，代表一共有几个声道。常见声音编码有：
...
DTS:X: DTS也是音效的技术标准之一。从时间上看，DTS公司在2015年才推出DTS:X技术，因为推出时间晚于杜比全景声，所以很多消费者更乐于接受杜比全景声，因为支持杜比全景声的设备和片源要远高于DTS:X。不过，DTS:X技术依然拥有比肩杜比全景声的实力。它旨在打造一种多维、逼真、生动的沉浸式环绕声效果，但又有不同的环绕声规范布局。在我们理解的杜比全景声里，它是地面、天空2层音箱布局，对天空扬声器也有摆放位置和角度的要求。DTS:X则不然，虽然也是2层架构，但对置顶环绕音箱可以摆放得更灵活，既可以作为地面扬声器的增高摆位，也可以摆出不同的倾斜角。DTS:X自身能够向下兼容，所以它可以应用在传统的5.1或7.1配置上，不需要为了新的技术另外购买新的环绕声套装，甚至买新的蓝光播放机。另外对于那些支持 DTS:X 的电影光盘，你拥有的是旧设备的话，也可以把它当成 DTS-HD Master Audio 标准
来播放。
...
GalaxyRG265代表发布组名称，不同发布组压制视频有不同风格，在此不过多赘述。NOGRP 表示来源不明，类似于「佚名」「群星」。
...
中文字幕分为中文简体和中文繁体字幕（港澳台），一些地方和字幕组以.chs代表中文简体字幕（Chinese-Simplified/Simplified Chinese的缩写），以.cht代表中


文繁体字幕（Traditional Chinese的缩写），例如Xx.chs.srt和Xx.cht.srt。
...
前者一般包含Season 01/S01/S1等字眼表示第一季（例）打包，此字眼会作为关键词被SONARR识别到下载哪一整季。两个例子：

Westworld S01 Season 1 Complete HDTV 720p x265 AAC E-Subs [GWC]

Solar.Opposites.S05.720p.10bit.WEBRip.2CH.x265.HEVC-PSA

后者包含S01E02等字眼表示第一季的第二集单集（例），有的也可包含多集例如S01E01-E03表示第一季的第一集到第三集共三集，此字眼会作为关键词被SONARR识别到在下载哪一（几）集。例子：
